...
namespace Cleverence.Barcoding.Integration.Plugin
{
    ...
    [Service(Exported = true, Permission = "com.cleverence.PluginPermission", Name = "cleverence.com.plugin.magdennewlandnls_nquire1000")]
    public class CustomService : RemoteBarcodeDeviceService
    {
        ...
        {
            return new CustomMobileComputer(this);
        }
