...
public class StandartUsbService extends Service {
    ...
    public void onCreate() {
        this.context = this;
        serialPortConnected = false;
        StandartUsbService.SERVICE_CONNECTED = true;
        setFilter();
    ...
    public void onDestroy() {
        ...
        StandartUsbService.SERVICE_CONNECTED = false;
    }
...
//                if (deviceVID != 0x1d6b && (devicePID != 0x0001 && devicePID != 0x0002 && devicePID != 0x0003) && deviceVID != 0x5c6 && devicePID != 0x904c) {
    ...
    public class UsbBinder extends Binder {
        public StandartUsbService getService() {
            return StandartUsbService.this;
        }
    }
